...
def main(spark):
    ...
    als = ALS(maxIter=20, regParam=0.001, rank=25, alpha=10, userCol="user_id", itemCol="rmsid_int", ratingCol="ratings",
    ...
    # print("Loading model")
    # model = ALSModel.load(f'hdfs:/user/ss16270_nyu_edu/als_model_r25_l001_a25_i10')
    # #
