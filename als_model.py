...
def main(spark):
    ...
    als = ALS(maxIter=15, regParam=0.001, rank=25, alpha=0.5, userCol="user_id", itemCol="rmsid_int", ratingCol="ratings",
               coldStartStrategy="drop", implicitPrefs=True)
    model = als.fit(train_data)
    model.write().overwrite().save(f'hdfs:/user/ss16270_nyu_edu/als_model_r25_l001_a05_i15')
