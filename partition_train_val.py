...
#     query_1.show()
    ...
    query_2 = spark.sql("SELECT recording_msid, COUNT(user_id) as cum_rating, COUNT(DISTINCT(user_id)) as num_users FROM train_set GROUP BY recording_msid ORDER BY cum_rating,num_users DESC LIMIT 100")
    query_2.show()
